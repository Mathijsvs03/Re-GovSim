...
class FishingConverseComponent(ConverseComponent):
    ...
    def converse_group(
        ...
        while True:
            ...
            print("THE END OF THE CONVERSALTION")
            print(end_conversation)
            print("THE LENGTH OF THE CURRENT CONVERSATION")
            print(len(current_conversation), max_conversation_steps)
            print(f"\n\nConversation is ending: {end_conversation}\n\n")
        ...
        print("KOMT HET UIT DE EERSTE CONVERSE LOOP")
