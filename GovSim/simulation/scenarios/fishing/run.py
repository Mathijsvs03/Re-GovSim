...
def run(
    ...
    # Remove type parameter for testing
    def remove_key_recursive(cfg: DictConfig, key_to_remove: str) -> DictConfig:
    ...
    cfg.personas = remove_key_recursive(cfg.personas, "type")
