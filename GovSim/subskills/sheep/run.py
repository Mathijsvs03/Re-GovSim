...
def main(cfg: DictConfig):
    ...
    if cfg.llm.out_format == "freeform":
        from .reasoning_free_format import (
            ...
            prompt_reflection_if_all_agents_that_same_quantity_universalization,
    ...
    class SimUnivConsequenceAfterFishingSameAmount(MathConsequenceAfterFishingSameAmount):
        def __init__(self, name="sim_consequence_after_using_same_amount_universalization") -> None:
            super().__init__(name)

        def prompt(self, *, persona, num_tonnes_lake, num_tonnes_fisher):
            return prompt_reflection_if_all_agents_that_same_quantity_universalization(
                wrapper,
                cot_prompt,
                persona,
                num_tonnes_lake,
    ...
    class MultipleSimUniverConsequenceAfterFishingSameAmount(
        ...
        def __init__(
            self, name="multiple_sim_universalization_consequence_after_using_same_amount"
        ) -> None:
            super().__init__(name)
