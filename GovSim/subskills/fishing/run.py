...
def main(cfg: DictConfig):
    ...
    if cfg.llm.out_format == "freeform":
        from .reasoning_free_format import (
            ...
            prompt_reflection_if_all_fisher_that_same_quantity_universalization,
            prompt_shrinking_limit,
            prompt_shrinking_limit_universalization,
            prompt_shrinking_limit_asumption,
            prompt_shrinking_limit_asumption_universalization,
    ...
    class SimUnivConsequenceAfterFishingSameAmount(MathConsequenceAfterFishingSameAmount):
        def __init__(self, name="sim_consequence_after_fishing_same_amount_universalization") -> None:
            super().__init__(name)

        def prompt(self, *, persona, num_tonnes_lake, num_tonnes_fisher):
            return prompt_reflection_if_all_fisher_that_same_quantity_universalization(
                wrapper,
                cot_prompt,
                persona,
                num_tonnes_lake,
    ...
    class SimUnivShrinkingLimit(MathShrinkingLimit):
        def __init__(self, name="sim_shrinking_limit_universalization") -> None:
            super().__init__(name)
        ...
        def prompt(
            ...
            *,
            ...
            return prompt_shrinking_limit_universalization(
                wrapper,
                cot_prompt,
                persona,
                num_tonnes_lake,
    ...
    class SimUnivShrinkingLimitAssumption(MathShrinkingLimitAssumption):
        def __init__(self, name="sim_shrinking_limit_assumption_universalization") -> None:
            super().__init__(name)
        ...
        def prompt(
            ...
            *,
            ...
            return prompt_shrinking_limit_asumption_universalization(
                wrapper,
                cot_prompt,
                persona,
                num_tonnes_lake,
    ...
    class MultipleSimUniverShrinkingLimit(SimUnivShrinkingLimit):
        def __init__(self, name="multiple_sim_universalization_shrinking_limit") -> None:
            super().__init__(name)
    ...
    class MultipleSimUniverShrinkingLimitAssumption(SimUnivShrinkingLimitAssumption):
        def __init__(self, name="multiple_sim_universalization_shrinking_limit_assumption") -> None:
            super().__init__(name)
    ...
    class MultipleSimUniverConsequenceAfterFishingSameAmount(
        SimUnivConsequenceAfterFishingSameAmount
    ):
        def __init__(
            self, name="multiple_sim_universalization_consequence_after_fishing_same_amount"
        ) -> None:
            super().__init__(name)
    ...
    test_cases_2 = [
        ...
        MultipleSimUniverShrinkingLimitAssumption(),
    ]
