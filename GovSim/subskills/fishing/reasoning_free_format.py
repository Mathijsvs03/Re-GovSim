...
# sustainable action subskill test case b without universalization
...
# sustainable action with universalization test case b
...
# sustainability threshold (belief) text case d with and without universalization
def prompt_shrinking_limit_universalization(
    model: ModelWandbWrapper,
    cot_prompt: str,
    persona: PersonaIdentity,
    num_tons_lake: int,
    ...
    lm = model.start_chain(
        persona.name, "fishing_cognition_act", "prompt_shrinking_limit_universalization"
    )
...
# test case c: sustainability threshold assumption with and without universalization
def prompt_shrinking_limit_asumption_universalization(
    model: ModelWandbWrapper,
    cot_prompt: str,
    persona: PersonaIdentity,
    num_tons_lake: int,
    ...
    lm = model.start_chain(
        persona.name, "fishing_cognition_act", "prompt_shrinking_limit_asumption_universalization"
    )
...
# test case a with and without universalization
def prompt_reflection_if_all_fisher_that_same_quantity_universalization(
    model: ModelWandbWrapper,
    cot_prompt: str,
    persona: PersonaIdentity,
    num_tons_lake: int,
...
# prompts below are not used in our experiments
