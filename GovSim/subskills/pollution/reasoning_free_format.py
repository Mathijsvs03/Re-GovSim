...
def prompt_shrinking_limit_universalization(
    ...
    lm = model.start_chain(
        persona.name, "pollution_cognition_act", "prompt_shrinking_limit_universalization"
    )
...
def prompt_shrinking_limit_asumption_universalization(
    ...
    lm = model.start_chain(
        persona.name, "pollution_cognition_act", "prompt_shrinking_limit_asumption_universalization"
    )
...
def prompt_reflection_if_all_agents_that_same_quantity_universalization(
    model: ModelWandbWrapper,
    cot_prompt: str,
    persona: PersonaIdentity,
    num: int,
